    ...
    <div class="col-xxl-12 my-4">
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <small class="text-body-secondary float-end">Update building information</small>
            </div>
            @if ($errors->any())
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('residences.buildings.update', [$residence, $building]) }}">
                    @csrf
                    @method('PUT')
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="name" class="form-control" id="basic-icon-default-fullname"
                                    ...
                                    aria-describedby="basic-icon-default-fullname2" value="{{ old('name', $building->name) }}">
                            </div>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="address" id="basic-icon-default-company" class="form-control"
                                    placeholder="Ex.PK-17 Station Neptune" value="{{ old('address', $building->address) }}"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" name="capacity" value="{{ old('capacity', $building->capacity) }}"
                    ...
                    <div class="row mb-6">
                        <label class="col-sm-2 col-form-label" for="building_status_id">Status</label>
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <span class="input-group-text"><i class="icon-base bx bx-envelope"></i></span>
                                <select name="building_status_id" class="form-select" id="exampleFormControlSelect1"
                            ...
                            <div class="form-text">What's the status of the building</div>
                            @error('building_status_id')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="{{ route('residences.buildings.index', $residence) }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
