    ...
    <div class="col-xxl-12 my-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Créer un Statut de Paiement</h5>
            </div>
            @if ($errors->any())
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('payment_statuses.store') }}">
                    @csrf
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="{{ route('payment_statuses.index') }}" class="btn btn-secondary">Annuler</a>
                        </div>
                    </div>
                </form>
            </div>
