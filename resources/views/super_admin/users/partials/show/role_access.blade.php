                        ...
                        <tr>
                            <td>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <small class="text-muted">{{ $roleInsights['scope_label'] ?? 'Assigned role' }}</small>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                @if ($userRole->permissions->isNotEmpty())
                                    <div class="d-flex flex-wrap gap-1">
                                ...
                                @else
                                    <span class="text-muted">No explicit permissions mapped</span>
                                @endif
                            </td>
                            <td>
