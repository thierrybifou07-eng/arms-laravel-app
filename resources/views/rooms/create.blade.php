...
@section('content')
    <div class="col-xxl-12 my-4">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('floors.rooms.store', $floor) }}">
                    @csrf
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="rent" class="form-control" id="basic-icon-default-fullname"
                                    ...
                                    aria-describedby="basic-icon-default-fullname2" value="{{ old('rent') }}"><span class="input-group-text">FCFA</span>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6">
