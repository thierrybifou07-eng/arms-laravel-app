...
<div class="container mx-auto py-6 max-w-md">
    <h1 class="text-3xl font-bold mb-6">Ajouter une Méthode de Paiement</h1>
    ...
    <form action="{{ route('payment_methods.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
