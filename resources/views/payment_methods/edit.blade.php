    ...
    <div class="col-xxl-12 my-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Éditer Méthode de Paiement</h5>
            </div>
            @if ($errors->any())
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('payment_methods.update', $payment_method) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $payment_method->name) }}"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="code" id="code" value="{{ old('code', $payment_method->code) }}"
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="{{ route('payment_methods.show', $payment_method) }}" class="btn btn-secondary">Annuler</a>
                        </div>
                    </div>
                </form>
            </div>
