...
<html lang="en" class="layout-wide customizer-hide" data-assets-path="{{ asset('admin-template/assets') }}/"
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6 col-md-6 form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text"
                                        ...
                                        id="firstname" name="firstname" placeholder="Enter your firstname"
                                        autofocus />
                                ...
                                <div class="col-lg-6 col-md-6 form-control-validation fv-plugins-icon-container">
                                    ...
                                    <input type="text" class="form-control @error('lastname') is-invalid @enderror"
                                        ...
                                        id="lastname" name="lastname" placeholder="Enter your lastname" autofocus />
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                        ...
                                        id="phone" placeholder="Enter your phone" autofocus />
                                    @error('phone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
